...
class OptionMenu {
        ...
        while (!end) {
            try {
                ...
                for (Map.Entry<Integer, Account> integerAccountEntry : data.entrySet()) {
                    Map.Entry pair = (Map.Entry) integerAccountEntry;
    ...
    public void mainMenu() throws IOException {
        data.put(952141, new Account(191904, 1000, 5000));
        data.put(123, new Account(123, 20000, 50000));
        boolean end = false;
        while (!end) {
            try {
                System.out.println("\n Type 1 - Login");
